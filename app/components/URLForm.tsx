      ...
      <div className="flex flex-col sm:flex-row items-center w-full">
        <div className="relative w-[80%]">
          ...
          <input
            ...
            className="w-full text-black h-12 px-4 py-4 pl-10 border-2 border-blue-200 rounded-l-lg sm:rounded-r-none focus:outline-none focus:border-blue-400"
            disabled={isLoading}
          />
        </div>
        <button
          type="submit"
          className={`w-[20%] h-12 sm:w-auto mt-2 sm:mt-0 px-4 ${!url.trim() ? "opacity-50 cursor-not-allowed" : "cursor-pointer"} bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-medium rounded-lg sm:rounded-l-none hover:from-blue-600 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-70 transition-all  duration-200 ease-in-out transform hover:scale-105 disabled:hover:scale-100`}
