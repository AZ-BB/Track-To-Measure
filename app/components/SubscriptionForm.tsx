...
export default function SubscriptionForm() {
  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      <div className="bg-gradient-to-r from-indigo-50 to-blue-50 p-8 rounded-xl shadow-sm border border-blue-100">
        <h3 className="text-center font-bold text-xl mb-6 text-gray-800">Get tracking tips & free tools</h3>
        ...
        {isSuccess ? (
          ...
          <form onSubmit={handleSubmit} className="w-full">
            <div className="flex flex-col sm:flex-row items-center w-full">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full px-4 py-4 pl-10 border-2 border-blue-200 rounded-lg sm:rounded-r-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            {error && (
              <div className="mt-3 text-red-600 text-sm bg-red-50 p-2 rounded">{error}</div>
            )}
